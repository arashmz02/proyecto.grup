...
- La tabla se llama 'resolucion_propuesta' (no 'resolucion')
  para no chocar con la 'resolucion' del motor de votaciones
  de Frank (Issue #12), que tiene un proposito diferente.
- La PK es 'id_resolucion_propuesta'.
- La FK en 'reforma_aplicada' es 'id_resolucion_propuesta'.
 
NOTA IMPORTANTE: el metodo aplicarReforma() inserta en
elemento_normativo una nueva version 'Vigente'. Esto DISPARA
el trigger tg_vigencia_normativa del Sprint 2 que automaticamente
marca la version anterior como 'Historico'. Es el punto donde el
Issue #10 Parte II se conecta con la infraestructura del Sprint 2
(versionamiento automatico de reglamentos).*/
public class Resolucion {
 
    private int idResolucionPropuesta;
    private int idPuntoAgenda;
    private String numeroResolucion;
    private LocalDateTime fechaEmision;
 
    //Getters 
    public int getIdResolucionPropuesta()    { return idResolucionPropuesta; }
    public int getIdPuntoAgenda()            { return idPuntoAgenda; }
    public String getNumeroResolucion()      { return numeroResolucion; }
    public LocalDateTime getFechaEmision()   { return fechaEmision; }
 
    /* Compatibilidad con codigo viejo que usaba getIdResolucion(). */
    public int getIdResolucion()             { return idResolucionPropuesta; }
 
 
    /*Crea un punto de agenda: vincula una propuesta con una sesion en un orden especifico. @return id del punto de agenda creado*/
    ...
    /*Emite una resolucion oficial sobre un punto de agenda. @param numeroResolucion codigo oficial (ej. 'AIR-RES-001-2024')
    ...
    public static int emitirResolucion(int idPuntoAgenda, String numeroResolucion,
        ...
        String sql = "INSERT INTO resolucion_propuesta " +
                     "(id_punto_agenda, numero_resolucion) " +
                     "VALUES (?, ?)";
    ...
    public static Resolucion obtenerPorId(int id) throws SQLException {
        String sql = "SELECT id_resolucion_propuesta, id_punto_agenda, " +
                     "       numero_resolucion, fecha_emision " +
                     "FROM resolucion_propuesta WHERE id_resolucion_propuesta = ?";
    ...
    public static Resolucion obtenerPorNumero(String numeroResolucion) throws SQLException {
        String sql = "SELECT id_resolucion_propuesta, id_punto_agenda, " +
                     "       numero_resolucion, fecha_emision " +
                     "FROM resolucion_propuesta WHERE numero_resolucion = ?";
    ...
    public static List<Resolucion> listarTodas() throws SQLException {
        String sql = "SELECT id_resolucion_propuesta, id_punto_agenda, " +
                     "       numero_resolucion, fecha_emision " +
                     "FROM resolucion_propuesta ORDER BY fecha_emision DESC";
    ...
    /*Aplica una reforma normativa derivada de una resolucion. El trigger tg_vigencia_normativa del Sprint 2 se encarga
    automaticamente de archivar la version anterior como 'Historico'. Aqui solo se registra el rastro en reforma_aplicada.*/
    public static int aplicarReforma(int idResolucionPropuesta, int idElementoNormativo,
        ...
        String sql = "INSERT INTO reforma_aplicada " +
                     "(id_resolucion_propuesta, id_elemento_normativo, id_tipo_reforma, " +
        ...
        try (Connection con = Conexion.obtener()) {
            ...
            try (PreparedStatement ps = con.prepareStatement(
                ...
                ps.setInt(1, idResolucionPropuesta);
    ...
    /*Devuelve todas las reformas aplicadas por una resolucion. Una sola resolucion puede modificar varios elementos normativos a la vez.*/
    public static List<ReformaVista> obtenerReformasDeResolucion(int idResolucionPropuesta)
            throws SQLException {
        ...
        String sql = "SELECT r.id_reforma, r.id_elemento_normativo, " +
                     ...
                     "WHERE r.id_resolucion_propuesta = ? " +
    ...
    private static Resolucion mapear(ResultSet rs) throws SQLException {
        ...
        r.idResolucionPropuesta = rs.getInt("id_resolucion_propuesta");
