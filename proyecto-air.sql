...
-- Autor: Frank
-- Sprint: 3
-- Descripción: Registro de votaciones (nominales y secretas)
-- con soporte para mayoría simple (50%+1) y calificada (66%).
-- Incluye tabla de resoluciones derivadas de cada votación.
-- ============================================================

-- ------------------------------------------------------------
-- 12.1  Tipos de mayoría en catalogo_maestro
-- ------------------------------------------------------------
IF NOT EXISTS (
...
-- ------------------------------------------------------------
-- 12.4  Estado de votación en catalogo_maestro
-- ------------------------------------------------------------
IF NOT EXISTS (
    SELECT 1 FROM catalogo_maestro
...
-- ------------------------------------------------------------
-- 12.8  Índices para queries de motor de votaciones
-- ------------------------------------------------------------
