...
-- Autor: Frank
-- Sprint: 3
-- Descripci鈮: Registro de votaciones (nominales y secretas)
-- con soporte para mayor蠁a simple (50%+1) y calificada (66%).
-- Incluye tabla de resoluciones derivadas de cada votaci鈮.
-- ============================================================

-- ------------------------------------------------------------
-- 12.1  Tipos de mayor蠁a en catalogo_maestro
-- ------------------------------------------------------------
IF NOT EXISTS (
    SELECT 1 FROM catalogo_maestro
...
-- ------------------------------------------------------------
-- 12.4  Estado de votaci鈮 en catalogo_maestro
-- ------------------------------------------------------------
IF NOT EXISTS (
    SELECT 1 FROM catalogo_maestro
...
-- ------------------------------------------------------------
-- 12.8  鈺恘dices para queries de motor de votaciones
-- ------------------------------------------------------------
