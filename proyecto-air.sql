...
-- ============================================================
-- ISSUE #13: BITÁCORA DE AUDITORÍA Y TRAZABILIDAD DE EMISIONES
-- Autor: Frank
-- Sprint: 3
-- Descripción: Tabla de log especializada para certificaciones
-- emitidas con hash SHA-256 (no repudio Art. 301 LGAP) y
-- registro de accesos sensibles a datos de asambleistas.
-- ============================================================

-- ------------------------------------------------------------
-- 13.1  Tipos de acción en catalogo_maestro
-- ------------------------------------------------------------
IF NOT EXISTS (
...
-- ------------------------------------------------------------
-- 13.4  Índices para queries de auditoria
-- ------------------------------------------------------------
